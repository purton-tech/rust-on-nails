...
To do this in production we can use [Oauth2 Proxy](https://github.com/oauth2-proxy/oauth2-proxy) and attach it to our preferred identity provider. This will supply us with a JWT identifing the user who is making the calls.
