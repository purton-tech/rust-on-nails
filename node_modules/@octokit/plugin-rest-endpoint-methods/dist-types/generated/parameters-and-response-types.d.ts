...
export declare type RestEndpointMethodTypes = {
    actions: {
        ...
        setActionsOidcCustomIssuerPolicyForEnterprise: {
            parameters: RequestParameters & Omit<Endpoints["PUT /enterprises/{enterprise}/actions/oidc/customization/issuer"]["parameters"], "baseUrl" | "headers" | "mediaType">;
    ...
    codespaces: {
        ...
        listInOrganization: {
            parameters: RequestParameters & Omit<Endpoints["GET /orgs/{org_id}/codespaces"]["parameters"], "baseUrl" | "headers" | "mediaType">;
